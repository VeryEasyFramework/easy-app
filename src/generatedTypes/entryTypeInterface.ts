import { ChildList } from "@vef/easy-app";
 ...
 */
fieldType?: 'IDField' | 'DataField' | 'IntField' | 'BigIntField' | 'DecimalField' | 'DateField' | 'TimeStampField' | 'BooleanField' | 'PasswordField' | 'ChoicesField' | 'MultiChoiceField' | 'TextField' | 'EmailField' | 'ImageField' | 'JSONField' | 'PhoneField' | 'ConnectionField' | 'RichTextField' | 'URLField' | 'ListField' | 'CurrencyField';
/**
 ...
 */
hook?: 'beforeInsert' | 'afterInsert' | 'beforeSave' | 'afterSave' | 'validate' | 'beforeValidate' | 'beforeDelete' | 'afterDelete';
/**
 * **Label** (DataField)
